...
function DealerCrops() {
 ...
 const socket = io(process.env.REACT_APP_API_URL);
  ...
  return (
    <div style={{ backgroundColor: colors.bgLight, minHeight: "100vh", padding: "40px 20px", fontFamily: "'Inter', sans-serif" }}>
      <div className="container">
        
        {/* HEADER SECTION */}
        <div style={{ marginBottom: "50px", textAlign: "center" }}>
          <h2 style={{ color: colors.textDark, fontWeight: "800", fontSize: "2.8rem", marginBottom: "10px" }}>
            Available Harvests
          </h2>
          <div style={{ width: "80px", height: "5px", background: colors.gold, borderRadius: "10px", margin: "0 auto 20px" }}></div>
          <p style={{ color: "#555", fontSize: "1.2rem", maxWidth: "600px", margin: "0 auto" }}>
            Secure the best yields by negotiating directly with our verified network of local farmers.
          </p>
        </div>
              ...
              >
                ...
                <div style={{ position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ 
                    ...
                    backgroundColor: "rgba(255, 255, 255, 0.95)", color: colors.primary,
                    padding: "10px 20px", borderRadius: "18px", fontWeight: "900",
                    boxShadow: "0 8px 20px rgba(0,0,0,0.1)", fontSize: "1.2rem",
                    backdropFilter: "blur(5px)"
                  }}>
                    ₹{crop.price} <span style={{fontSize: '0.8rem', color: '#666', fontWeight: '500'}}>/ quintal</span>
                  </div>
                </div>
                ...
                <div className="card-body p-4">
                  <div className="mb-3 d-flex justify-content-between align-items-center">
                    <div>
                      <h4 style={{ fontWeight: "800", color: colors.textDark, marginBottom: "2px", fontSize: "1.4rem" }}>
                        {crop.cropName}
                      </h4>
                      <div style={{ color: colors.primary, fontWeight: "700", fontSize: "0.9rem", display: "flex", alignItems: "center", gap: "5px" }}>
                  ...
                  <div style={{ background: colors.bgLight, padding: "12px 18px", borderRadius: "16px", marginBottom: "20px" }}>
                    <span style={{ color: "#666", fontSize: "0.9rem", fontWeight: "600" }}>Available Stock: </span>
                    <span style={{ color: colors.textDark, fontWeight: "800", fontSize: "1rem" }}>{crop.quantity} kg</span>
                  </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    ...
                    <button
                      ...
                      onMouseOut={(e) => { e.target.style.borderColor = colors.border; e.target.style.color = colors.textDark; }}
